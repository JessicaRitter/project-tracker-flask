...
def get_project_by_title(title):
    ...
    print "Project: {title}\n{description}".format(title=row[0],
                                                     description=row[1])
...
def get_grade_by_github_title(github, title):
    ...
    print "Github {github} got grade {grade} on project {project}".format(github=row[0],
                                                                            grade=row[1],
                                                                            project=row[2])
...
def assign_grade(github, title, grade):
    ...
    print "Successfully added grade {grade} to github {github} on project {title}".format(grade=grade, github=github, title=title)
